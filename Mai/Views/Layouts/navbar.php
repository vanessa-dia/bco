<div class="bg-light container d-flex flex-row justify-content-between font-Quicksand">
  <div class="my-auto p-1 text-danger">
    <h6 class="my-auto"><i class="fas fa-phone"></i> Hotline: 0395858585</h6>
  </div>
  <?php if (isset($_SESSION['user'])) { ?>
    <div class="dropdown show my-auto d-flex flex-row">
      ...
      <a class="dropdown-toggle a-btn text-secondary" href="#" data-toggle="dropdown">Tài khoản</a>
      <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="<?= $baseUrl ?>/Profile">Hồ sơ</a>
        <div class="dropdown-divider"></div>
        <a href="<?= $baseUrl ?>/Profile/signOut" class="dropdown-item">Đăng xuất</a>
      </div>
    </div>
  <?php } else { ?>
    <div class="my-auto d-flex flex-row ">
      ...
      <a class="text-secondary a-btn" id="signin">
        <h6 class="my-auto ml-2"><i class="fas fa-sign-in-alt"></i>Đăng nhập</h6>
      </a>
      <a class="text-secondary a-btn" id="signup">
        <h6 class="my-auto ml-2"><i class="fas fa-user"></i>Đăng ký</h6>
      </a>
    </div>
  <?php } ?>
</div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?= $activeNav[0] ?>">
        <a class="nav-link" href="<?= $baseUrl ?>/home">Trang chủ</a>
      </li>
